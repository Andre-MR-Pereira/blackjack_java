...
public class Main {
	...
	/**
	 * Main do projeto de blackjack.
	 * Verifica e processa os argumentos, chamando o método adequado do game.
	 * @see Game
	 * @param args argumentos utilizados pelo utilizador.
	 * @throws FileNotFoundException Tentativa de usar um ficheiro, que não pôde ser aberto.
	 */
